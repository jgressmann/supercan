...
TEST_F (fixture, cbt_computes_sensible_values)
{
    ...
    CHECK_EQUAL(1u, settings_nominal.brp);
    CHECK_EQUAL(1u, settings_nominal.sjw);
    CHECK_EQUAL(127u, settings_nominal.tseg1);
    CHECK_EQUAL(32u, settings_nominal.tseg2);
    ...
    CHECK_EQUAL(1u, settings_nominal.brp);
    CHECK_EQUAL(1u, settings_nominal.sjw);
    CHECK_EQUAL(63u, settings_nominal.tseg1);
    CHECK_EQUAL(16u, settings_nominal.tseg2);
    ...
    CHECK_EQUAL(1u, settings_data.brp);
    CHECK_EQUAL(1u, settings_data.sjw);
    CHECK_EQUAL(27u, settings_data.tseg1);
    CHECK_EQUAL(12u, settings_data.tseg2);
    ...
    CHECK_EQUAL(1u, settings_data.brp);
    CHECK_EQUAL(1u, settings_data.sjw);
    CHECK_EQUAL(10u, settings_data.tseg1);
    CHECK_EQUAL(5u, settings_data.tseg2);
    ...
    CHECK_EQUAL(CAN_BTRE_NONE, cbt_real(&hw_data, &user_data, &settings_data));
    CHECK_EQUAL(1u, settings_data.brp);
    CHECK_EQUAL(3u, settings_data.sjw);
    CHECK_EQUAL(6u, settings_data.tseg1);
    CHECK_EQUAL(3u, settings_data.tseg2);
    // data brp=1 sjw=1 tseg1=6 tseg2=3 bitrate=8000000 sp=666/1000
...
TEST_F (fixture, cbt_computes_leaves_sjw_at_the_user_setting)
{
    ...
    for (unsigned i = 1; i <= hw_nominal.sjw_max; ++i) {
        user_nominal.sjw = i;
